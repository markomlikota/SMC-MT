...
S_pr_SVx4     = deepcopy(S_pr)
v_pr_SVx4     = deepcopy(v_pr)

μ_pr_SVx4     = deepcopy(μ_pr)
P_pr_SVx4     = deepcopy(P_pr)



# Define fPriorDraw_Mi(), fPriorLogEval_Mi(ϑMi), fIsDrawValid_Mi(ϑMi):

function fPriorDraw_SVx4()
    ...
    Σ, Φ        = fOneDrawMNIW(μ_pr_SVx4,P_pr_SVx4,S_pr_SVx4,v_pr_SVx4)
    ...
    ϑ           = fVARObjectsToϑ_SVx4(Φ, Σ, vρ, vξ)
...
function fPriorLogEval_SVx4(ϑ)
    ...
    prprΦΣ        = fEvalMNIW(Φ,Σ,μ_pr_SVx4,P_pr_SVx4,S_pr_SVx4,v_pr_SVx4)
    ...
    vP[mParaPointers_SVx4[1,1]]                       = prprΦΣ
    vP[mParaPointers_SVx4[3,1]:mParaPointers_SVx4[3,2]] = vprprρ
    vP[mParaPointers_SVx4[4,1]:mParaPointers_SVx4[4,2]] = vprprξ
...
function fIsDrawValid_SVx4(ϑ)
    ...
    # vValid[mParaPointers_SVx4[1,1]]                     = isVARstationary
    vValid[mParaPointers_SVx4[1,1]]                       = isSigPD
    vValid[mParaPointers_SVx4[3,1]:mParaPointers_SVx4[3,2]] = vIsSVstationary
    vValid[mParaPointers_SVx4[4,1]:mParaPointers_SVx4[4,2]] = vAreXisPositive
