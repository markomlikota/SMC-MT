...
# Main script to simulate data for RBC based on model "L3" given DGP specified below.
...
noMEs       = true        # set measurement errors to zero? -> e.g. for calibrating them
...
fΦ, fΨ, fDrawInitialStatesBSPF = fSolveModelL3(θ0)
...
mY, mX, mε, mu = fSimulate_mL3(fΨ,fΦ,θ0,nY,nS,nε, T)
