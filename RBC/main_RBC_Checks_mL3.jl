...
# Script to check a few things for model "L3"
...
# -- Compare Simulated Data under mL1 and mL3 ---------------------------------


sFolderForOutput    = sMyPath * "Data/"

mData_mL1   = fGetFile(sMyPath * "Data/","Data_" * string("dgp",DGPspec) * "_mL1" * ".csv")
mData_mL3   = fGetFile(sMyPath * "Data/","Data_" * string("dgp",DGPspec) * "_mL3" * ".csv")
...
plot!(1:T,mData_mL3[:,1],label="L3",line=(myRed,0.9,2,:line))

p2          = fMyPlot(1:T,mData_mL1[:,2],vYlabs[2],"","","L1",myBlue)
plot!(1:T,mData_mL3[:,2],label="L3",line=(myRed,0.9,2,:line))

p3          = fMyPlot(1:T,mData_mL1[:,3],vYlabs[3],"t","","L1",myBlue)
plot!(1:T,mData_mL3[:,3],label="L3",line=(myRed,0.9,2,:line))

pp          = plot(p1,p2,p3,layout=(3,1))
display(pp)

sFileForOutput         = "Data_" * string("dgp",DGPspec) *"_L1vsL3" * ".png"
